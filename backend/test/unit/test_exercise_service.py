...
class TestExerciseService:
    ...
    def test_create_exercise_com_peso_success(self, mock_com_peso, mock_exercicio_class, mock_create_details, mock_convert, mock_db, mock_exercicio_com_peso):
    ...
    def test_create_exercise_sem_peso_success(self, mock_sem_peso, mock_exercicio_class, mock_create_details, mock_convert, mock_db, mock_exercicio_sem_peso):
        exercicio_data = ExercicioCreate(
            nome="Corrida",
            serie=1,
            repeticoes=1,
    ...
    def test_get_exercise_by_id_found(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_com_peso):
        mock_result = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_get_exercise_by_id_not_found(self, mock_select, mock_selectinload, mock_db):
        mock_result = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_get_exercises_by_type_com_peso(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_com_peso):
        mock_result = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_get_exercises_by_type_sem_peso(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_sem_peso):
        mock_result = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_get_all_exercises(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_com_peso, mock_exercicio_sem_peso):
        mock_result = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_update_exercise_com_peso_success(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_com_peso):
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_update_exercise_sem_peso_success(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_sem_peso):
        update_data = ExercicioUpdate(
    ...
    @patch('app.services.exercise_service.select')
    def test_delete_exercise_success(self, mock_select, mock_db, mock_exercicio_com_peso):
        mock_result = Mock()
        mock_result.scalars.return_value.first.return_value = mock_exercicio_com_peso
        mock_db.execute.return_value = mock_result
        mock_db.delete = Mock()
    ...
    @patch('app.services.exercise_service.select')
    def test_delete_exercise_with_training_links(self, mock_select, mock_db, mock_exercicio_com_peso):
        mock_result = Mock()
        mock_result.scalars.return_value.first.return_value = mock_exercicio_com_peso
        mock_db.execute.return_value = mock_result
        mock_db.delete = Mock()
    ...
    @patch('app.services.exercise_service.selectinload')
    @patch('app.services.exercise_service.select')
    def test_get_exercises_in_training(self, mock_select, mock_selectinload, mock_convert, mock_db, mock_exercicio_com_peso):
    ...
    def test_convert_exercicio_model_to_out_schema_com_peso(self, mock_exercicio_com_peso):
    ...
    def test_convert_exercicio_model_to_out_schema_sem_peso(self, mock_exercicio_sem_peso):
    ...
    def test_create_exercise_details_in_db_com_peso(self, mock_db):
        ...
        exercise_service._create_exercise_details_in_db(mock_db, exercicio_obj, exercicio_schema)
