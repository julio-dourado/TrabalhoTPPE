from sqlalchemy import Column, Integer, String, Float, Date, Enum, DateTime, Text, Boolean
...
class User(Base):
    ...
    training_experience_years = Column(Integer, default=0)
    ...
    # Relationships (comentados temporariamente para focar na autenticação)
